...
class WorkshopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post workshops_url, params: { workshop: { first_description: @workshop.first_description, first_title: @workshop.first_title } }
    end
  ...
  test "should update workshop" do
    patch workshop_url(@workshop), params: { workshop: { first_description: @workshop.first_description, first_title: @workshop.first_title } }
